...
namespace OnlineShopping_csit.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ProductController(OnlineShopping_csitContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Price,Image,CategoryId")] Product product, IFormFile photo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Price,Image,CategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
